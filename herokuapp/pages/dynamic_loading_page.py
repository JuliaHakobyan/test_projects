...
class DynamicLoadingPage(BasePage):
    ...
    example_1_text_present = {"by": By.XPATH, "value": "//*[@id='finish']/h4"}
    example_2_text = {"by": By.XPATH, "value": "//*[@id='finish']/h4"}


    def dynamic_page_title_present(self):
        return self.is_displayed(self.dynamically_loaded_page_title)
    ...
    def example_1_start_button_click(self):
        self.click(self.example_1_text_present)
